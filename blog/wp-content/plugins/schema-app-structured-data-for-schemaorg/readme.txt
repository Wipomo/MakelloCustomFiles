...
- Improve, Include the data-source attribute on the JSON-LD output generated by this plugin

= 2.1.0 =
Release Date - 03 May 2024

- Improve, Add @id to Breadcrumb markup
- Fix, Fixed routine that sends markup to SchemaApp for paid accounts

= 2.0.0 =
Release Date - 02 April 2024

- Fix, Added referrer header to requests to Schema App's CDN.
- Dropped support for versions earlier than WordPress 4.4
