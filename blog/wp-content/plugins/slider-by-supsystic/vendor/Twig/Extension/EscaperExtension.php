...
final class EscaperExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFilter('escape', 'Twig_SupTwg_escape_filter', ['needs_environment' => true, 'is_safe_callback' => 'Twig_SupTwg_escape_filter_is_safe']),
            new TwigFilter('e', 'Twig_SupTwg_escape_filter', ['needs_environment' => true, 'is_safe_callback' => 'Twig_SupTwg_escape_filter_is_safe']),
            new TwigFilter('raw', 'Twig_SupTwg_raw_filter', ['is_safe' => ['all']]),
        ];
    }
...
class_alias('Twig\Extension\EscaperExtension', 'Twig_SupTwg_Extension_Escaper');
}
 ...
 * @return string
 */
function Twig_SupTwg_escape_filter(Environment $env, $string, $strategy = 'html', $charset = null, $autoescape = false)
{
 ...
 * @internal
 */
function Twig_SupTwg_escape_filter_is_safe(Node $filterArgs)
{
