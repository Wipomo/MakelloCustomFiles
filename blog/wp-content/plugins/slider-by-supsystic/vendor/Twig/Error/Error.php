...
class Error extends \Exception
{
    ...
    public function __construct(string $message, int $lineno = -1, $source = null, \Exception $previous = null)
    {
        ...
        if (null === $source) {
            $name = null;
        } elseif (!$source instanceof Source && !$source instanceof \Twig_SupTwg_Source) {
    ...
    private function guessTemplateInfo()
    {
        ...
        foreach ($backtrace as $trace) {
            if (isset($trace['object']) && $trace['object'] instanceof Template && 'Twig_SupTwg_Template' !== \get_class($trace['object'])) {
...
class_alias('Twig\Error\Error', 'Twig_SupTwg_Error');
