...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters()
    {
        return [
            // formatting filters
            new TwigFilter('date', 'Twig_SupTwg_date_format_filter', ['needs_environment' => true]),
            new TwigFilter('date_modify', 'Twig_SupTwg_date_modify_filter', ['needs_environment' => true]),
            new TwigFilter('format', 'sprintf'),
            new TwigFilter('replace', 'Twig_SupTwg_replace_filter'),
            new TwigFilter('number_format', 'Twig_SupTwg_number_format_filter', ['needs_environment' => true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', 'Twig_SupTwg_round'),

            // encoding
            new TwigFilter('url_encode', 'Twig_SupTwg_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', 'Twig_SupTwg_convert_encoding'),

            // string filters
            new TwigFilter('title', 'Twig_SupTwg_title_string_filter', ['needs_environment' => true]),
            new TwigFilter('capitalize', 'Twig_SupTwg_capitalize_string_filter', ['needs_environment' => true]),
            new TwigFilter('upper', 'Twig_SupTwg_upper_filter', ['needs_environment' => true]),
            new TwigFilter('lower', 'Twig_SupTwg_lower_filter', ['needs_environment' => true]),
            new TwigFilter('striptags', 'strip_tags'),
            new TwigFilter('trim', 'Twig_SupTwg_trim_filter'),
            new TwigFilter('nl2br', 'nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', 'Twig_SupTwg_spaceless', ['is_safe' => ['html']]),

            // array helpers
            new TwigFilter('join', 'Twig_SupTwg_join_filter'),
            new TwigFilter('split', 'Twig_SupTwg_split_filter', ['needs_environment' => true]),
            new TwigFilter('sort', 'Twig_SupTwg_sort_filter'),
            new TwigFilter('merge', 'Twig_SupTwg_array_merge'),
            new TwigFilter('batch', 'Twig_SupTwg_array_batch'),
            new TwigFilter('column', 'Twig_SupTwg_array_column'),
            new TwigFilter('filter', 'Twig_SupTwg_array_filter'),
            new TwigFilter('map', 'Twig_SupTwg_array_map'),
            new TwigFilter('reduce', 'Twig_SupTwg_array_reduce'),

            // string/array filters
            new TwigFilter('reverse', 'Twig_SupTwg_reverse_filter', ['needs_environment' => true]),
            new TwigFilter('length', 'Twig_SupTwg_length_filter', ['needs_environment' => true]),
            new TwigFilter('slice', 'Twig_SupTwg_slice', ['needs_environment' => true]),
            new TwigFilter('first', 'Twig_SupTwg_first', ['needs_environment' => true]),
            new TwigFilter('last', 'Twig_SupTwg_last', ['needs_environment' => true]),

            // iteration and runtime
            new TwigFilter('default', '_Twig_SupTwg_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', 'Twig_SupTwg_get_array_keys_filter'),
        ];
    }
    ...
    public function getFunctions()
    {
        return [
            ...
            new TwigFunction('constant', 'Twig_SupTwg_constant'),
            new TwigFunction('cycle', 'Twig_SupTwg_cycle'),
            new TwigFunction('random', 'Twig_SupTwg_random', ['needs_environment' => true]),
            new TwigFunction('date', 'Twig_SupTwg_date_converter', ['needs_environment' => true]),
            new TwigFunction('include', 'Twig_SupTwg_include', ['needs_environment' => true, 'needs_context' => true, 'is_safe' => ['all']]),
            new TwigFunction('source', 'Twig_SupTwg_source', ['needs_environment' => true, 'is_safe' => ['all']]),
        ];
    }
    ...
    public function getTests()
    {
        return [
            ...
            new TwigTest('empty', 'Twig_SupTwg_test_empty'),
            new TwigTest('iterable', 'Twig_SupTwg_test_iterable'),
        ];
    }
...
class_alias('Twig\Extension\CoreExtension', 'Twig_SupTwg_Extension_Core');
}
 ...
 */
function Twig_SupTwg_random(Environment $env, $values = null, $max = null)
{
    if (null === $values) {
    ...
    if (!Twig_SupTwg_test_iterable($values)) {
        return $values;
    }

    $values = Twig_SupTwg_to_array($values);
 ...
 */
function Twig_SupTwg_date_format_filter(Environment $env, $date, $format = null, $timezone = null)
{
    if (null === $format) {
 ...
 */
function Twig_SupTwg_date_modify_filter(Environment $env, $date, $modifier)
{
 ...
 * @return \DateTimeInterface
 */
function Twig_SupTwg_date_converter(Environment $env, $date = null, $timezone = null)
{
 ...
 * @return string
 */
function Twig_SupTwg_replace_filter($str, $from)
{
    if (!Twig_SupTwg_test_iterable($from)) {
        throw new RuntimeError(sprintf('The "replace" filter expects an array or "Traversable" as replace values, got "%s".', \is_object($from) ? \get_class($from) : \gettype($from)));
    }

    return strtr($str, Twig_SupTwg_to_array($from));
}
 ...
 */
function Twig_SupTwg_number_format_filter(Environment $env, $number, $decimal = null, $decimalPoint = null, $thousandSep = null)
{
...
{
    if (!Twig_SupTwg_test_iterable($arr1)) {
    ...
    if (!Twig_SupTwg_test_iterable($arr2)) {
    ...
    return array_merge(Twig_SupTwg_to_array($arr1), Twig_SupTwg_to_array($arr2));
}
 ...
 */
function Twig_SupTwg_slice(Environment $env, $item, $start, $length = null, $preserveKeys = false)
{
 ...
 */
function Twig_SupTwg_first(Environment $env, $item)
{
 ...
 */
function Twig_SupTwg_last(Environment $env, $item)
{
 ...
 */
function Twig_SupTwg_join_filter($value, $glue = '', $and = null)
{
    if (!Twig_SupTwg_test_iterable($value)) {
        $value = (array) $value;
    }

    $value = Twig_SupTwg_to_array($value, false);
 ...
 */
function Twig_SupTwg_split_filter(Environment $env, $value, $delimiter, $limit = null)
{
 ...
 */
function Twig_SupTwg_reverse_filter(Environment $env, $item, $preserveKeys = false)
{
    if ($item instanceof \Traversable) {
 ...
 * @return array
 */
function Twig_SupTwg_sort_filter($array, $arrow = null)
{
    if ($array instanceof \Traversable) {
 ...
 * @return string
 */
function Twig_SupTwg_spaceless($content)
{
 ...
 */
function Twig_SupTwg_length_filter(Environment $env, $thing)
{
    if (null === $thing) {
        return 0;
    }
 ...
 */
function Twig_SupTwg_upper_filter(Environment $env, $string)
{
 ...
 */
function Twig_SupTwg_lower_filter(Environment $env, $string)
{
 ...
 */
function Twig_SupTwg_title_string_filter(Environment $env, $string)
{
 ...
 */
function Twig_SupTwg_capitalize_string_filter(Environment $env, $string)
{
    $charset = $env->getCharset();
 ...
 * @internal
 */
function Twig_SupTwg_call_macro(Template $template, string $method, array $args, int $lineno, array $context, Source $source)
{
 ...
 * @internal
 */
function Twig_SupTwg_to_array($seq, $preserveKeys = true)
{
 ...
 */
function Twig_SupTwg_include(Environment $env, $context, $template, $variables = [], $withContext = true, $ignoreMissing = false, $sandboxed = false)
{
 ...
 */
function Twig_SupTwg_source(Environment $env, $name, $ignoreMissing = false)
{
 ...
 * @return array
 */
function Twig_SupTwg_array_batch($items, $size, $fill = null, $preserveKeys = true)
{
    if (!Twig_SupTwg_test_iterable($items)) {
        throw new RuntimeError(sprintf('The "batch" filter expects an array or "Traversable", got "%s".', \is_object($items) ? \get_class($items) : \gettype($items)));
    }

    $size = ceil($size);

    $result = array_chunk(Twig_SupTwg_to_array($items, $preserveKeys), $size, $preserveKeys);
 ...
 * @internal
 */
function Twig_SupTwg_get_attribute(Environment $env, Source $source, $object, $item, array $arguments = [], $type = /* Template::ANY_CALL */ 'any', $isDefinedTest = false, $ignoreStrictCheck = false, $sandboxed = false, int $lineno = -1)
{
    // array
 ...
 */
function Twig_SupTwg_array_column($array, $name, $index = null): array
{
    if ($array instanceof Traversable) {
        $array = iterator_to_array($array);
    } elseif (!\is_array($array)) {
...
function Twig_SupTwg_array_filter($array, $arrow)
{
    if (\is_array($array)) {
...
function Twig_SupTwg_array_map($array, $arrow)
{
    $r = [];
...
function Twig_SupTwg_array_reduce($array, $arrow, $initial = null)
{
    if (!\is_array($array)) {
        $array = iterator_to_array($array);
    }
