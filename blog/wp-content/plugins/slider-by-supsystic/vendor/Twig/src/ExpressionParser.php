        ...
        switch ($token->getType()) {
            ...
            case /* Token::OPERATOR_TYPE */ 8:
                if (preg_match(Lexer::REGEX_NAME, $token->getValue(), $matches) && $matches[0] == $token->getValue()) {
                    ...
                    if (!(\in_array($ref->getName(), [NegUnary::class, PosUnary::class, 'Twig_SupTwg_Node_Expression_Unary_Neg', 'Twig_SupTwg_Node_Expression_Unary_Pos'])
                        || $ref->isSubclassOf(NegUnary::class) || $ref->isSubclassOf(PosUnary::class)
                        || $ref->isSubclassOf('Twig_SupTwg_Node_Expression_Unary_Neg') || $ref->isSubclassOf('Twig_SupTwg_Node_Expression_Unary_Pos'))
                    ) {
...
class_alias('Twig\ExpressionParser', 'Twig_SupTwg_ExpressionParser');
